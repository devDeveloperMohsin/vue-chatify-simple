										...
										<a href="#">
											<div class="media">
												...
												<div class="chat-user-img online align-self-center mr-3">
													<img src="/chat_assets/images/users/avatar-2.jpg" class="rounded-circle avatar-xs" alt="">
			...
			<div class="d-lg-flex">
						...
						<div class="row align-items-center">
							<div class="col-sm-4 col-8">
								<div class="media align-items-center">
									...
									<div class="media-body overflow-hidden">
										<h5 class="font-size-16 mb-0 text-truncate"><a href="#" class="text-reset user-profile-show">Doris
												Brown</a>
										</h5>
									</div>
								</div>
											...
											<div class="ctext-wrap-content">
												<ul class="list-inline message-img  mb-0">
													<li class="list-inline-item message-img-list">
														<div>
															<a class="popup-img d-inline-block m-1" href="/chat_assets/images/small/img-1.jpg"
																title="Project 1">
																<img src="/chat_assets/images/small/img-1.jpg" alt="" class="rounded border">
															</a>
														</div>
													...
													<li class="list-inline-item message-img-list">
														<div>
															<a class="popup-img d-inline-block m-1" href="/chat_assets/images/small/img-2.jpg"
																title="Project 2">
																<img src="/chat_assets/images/small/img-2.jpg" alt="" class="rounded border">
															</a>
														</div>
														<div class="message-img-link">
															<ul class="list-inline mb-0">
				...
				<div class="user-profile-sidebar" style="display:block">
					...
					<div class="text-center p-4 border-bottom">
						<div class="mb-4">
							<img src="/chat_assets/images/users/avatar-4.jpg" class="rounded-circle avatar-lg img-thumbnail" alt="">
						</div>
											...
											<div class="media align-items-center">
												...
												<div class="ml-4">
													<ul class="list-inline mb-0 font-size-18">
														...
														<li class="list-inline-item dropdown">
															<a class="dropdown-toggle text-muted px-1" href="#" role="button" data-toggle="dropdown"
																aria-haspopup="true" aria-expanded="false">
																<i class="ri-more-fill"></i>
															</a>
															<div class="dropdown-menu dropdown-menu-right">
